...
#include "WebSocketNetworkNetDriver.generated.h"

class FWebSocket;
class FWebSocketServer;

UCLASS(transient, config = Engine)
class WEBSOCKETNETWORKING_API UWebSocketNetworkNetDriver : public UNetDriver
{
	...
	*/
	...
	class UWebSocketNetworkConnection* GetServerConnection();
